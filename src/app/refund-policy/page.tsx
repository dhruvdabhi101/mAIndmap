  ...
  return (
    <>
      <div><h1><strong>Return &amp; Refund Policy</strong></h1>
        ...
        <p>Our Return and Refund Policy was last updated on <strong>20/02/2025</strong>.</p>

        <p>Thank you for shopping at <strong>mAIndmap</strong>.</p>
        ...
        <p>Refund requests must be made within <strong>2</strong> days of the payment date. Requests made after this period will not be eligible for a refund.</p>
