const TOS = () => {
  return (
    <>
      <div><p>Our Terms and Conditions were last updated on <strong>20/02/2025</strong>.</p>
        ...
        <p>All content, features, and functionality of our services, including but not limited to text, graphics, logos, and software, are the exclusive property of <strong>mAIndmap</strong> and are protected by international copyright, trademark, and other intellectual property laws.</p>
        ...
        <p>You can contact our copyright agent via email at <a href="mailto:dhruvdabhi101@gmail.com">dhruvdabhi101@gmail.com</a>. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removing the challenged content from the Service.</p>
        ...
        <ul><li>By visiting our website: <a href="www.maindmap.xyz" target="_blank" rel="noopener noreferrer">www.maindmap.xyz</a></li><li>By sending us an email: <a href="mailto:dhruvdabhi101@gmail.com">dhruvdabhi101@gmail.com</a></li></ul></div>
    </>
  )
}
export default TOS;
